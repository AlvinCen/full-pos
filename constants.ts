...
import { User, UserRole, Outlet, Category, Unit, Product, Purchase, PurchaseStatus, Sale, PaymentMethod, BilliardTable, TableStatus, BilliardTableType, PricelistPackage, PricingUnit, RoundingMethod } from './types';
...
export const initialSales: Sale[] = [
    {
        id: 'sale-1', outletId: 'outlet-1', userId: 'user-4', invoiceNo: 'INV-0001', date: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(), subtotal: 55000, discount: 0, tax: 5500, total: 60500, paymentMethod: PaymentMethod.CASH, paid: 70000, change: 9500,
        items: [
    ...
    {
        id: 'sale-2', outletId: 'outlet-1', userId: 'user-4', invoiceNo: 'INV-0002', date: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(), subtotal: 100000, discount: 10000, tax: 9000, total: 99000, paymentMethod: PaymentMethod.QRIS, paid: 99000, change: 0,
        items: [
